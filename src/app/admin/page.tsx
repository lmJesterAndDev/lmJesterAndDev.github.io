...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    // Берём все задания из localStorage
  ...
  // Фильтр задач по выбранному пользователю
    ...
    <div className="min-h-screen bg-[#0b0e13] text-white flex">
      ...
      <div className="w-60 border-r border-gray-800 p-4 flex flex-col gap-2">
        ...
        {users.map(u => (
          <Button
            key={u}
            className={`text-left ${selectedUser === u ? 'bg-cyan-500/20' : ''}`}
